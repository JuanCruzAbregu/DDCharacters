...
public class Equipo {
    ...
    private String _obj2Escudo;
    private String _obj2Ca;
    private String _obj2DesMax;
    private String _obj2Fallo;
    private String _obj2Pen;
    private String _obj2Esp;
    private String _obj2Peso;
    private String _obj3Obj;
    private String _obj3Ca;
    private String _obj3Peso;
    private String _obj3Esp;
    private String _obj4Obj;
    ...
    public Equipo(String _arma1Arma, String _arma1Danio, String _arma1Critico, String _arma1Tipo, String _arma1Peso,  String _arma1Alcance, String _arma1Notas, String _arma1Municion,
        ...
        this._obj2Escudo = _obj2Escudo;
        this._obj2Ca = _obj2Ca;
        this._obj2DesMax = _obj2DesMax;
        this._obj2Fallo = _obj2Fallo;
        this._obj2Pen = _obj2Pen;
        this._obj2Esp = _obj2Esp;
        this._obj2Peso = _obj2Peso;
        this._obj3Obj = _obj3Obj;
        this._obj3Ca = _obj3Ca;
        this._obj3Peso = _obj3Peso;
        this._obj3Esp = _obj3Esp;
        this._obj4Obj = _obj4Obj;
    ...
    public String get_obj2Escudo() {
        return _obj2Escudo;
    }

    public void set_obj2Escudo(String _obj2Escudo) {
        this._obj2Escudo = _obj2Escudo;
    }

    public String get_obj2Ca() {
        return _obj2Ca;
    }

    public void set_obj2Ca(String _obj2Ca) {
        this._obj2Ca = _obj2Ca;
    }

    public String get_obj2DesMax() {
        return _obj2DesMax;
    }

    public void set_obj2DesMax(String _obj2DesMax) {
        this._obj2DesMax = _obj2DesMax;
    }

    public String get_obj2Fallo() {
        return _obj2Fallo;
    }

    public void set_obj2Fallo(String _obj2Fallo) {
        this._obj2Fallo = _obj2Fallo;
    }

    public String get_obj2Pen() {
        return _obj2Pen;
    }

    public void set_obj2Pen(String _obj2Pen) {
        this._obj2Pen = _obj2Pen;
    }

    public String get_obj2Esp() {
        return _obj2Esp;
    }

    public void set_obj2Esp(String _obj2Esp) {
        this._obj2Esp = _obj2Esp;
    }

    public String get_obj2Peso() {
        return _obj2Peso;
    }

    public void set_obj2Peso(String _obj2Peso) {
        this._obj2Peso = _obj2Peso;
    }

    public String get_obj3Obj() {
        return _obj3Obj;
    }

    public void set_obj3Obj(String _obj3Obj) {
        this._obj3Obj = _obj3Obj;
    }

    public String get_obj3Ca() {
        return _obj3Ca;
    }

    public void set_obj3Ca(String _obj3Ca) {
        this._obj3Ca = _obj3Ca;
    }

    public String get_obj3Peso() {
        return _obj3Peso;
    }

    public void set_obj3Peso(String _obj3Peso) {
        this._obj3Peso = _obj3Peso;
    }

    public String get_obj3Esp() {
        return _obj3Esp;
    }

    public void set_obj3Esp(String _obj3Esp) {
        this._obj3Esp = _obj3Esp;
    }

    public String get_obj4Obj() {
        return _obj4Obj;
    }

    public void set_obj4Obj(String _obj4Obj) {
        this._obj4Obj = _obj4Obj;
    }

    public String get_obj4Ca() {
        return _obj4Ca;
    }

    public void set_obj4Ca(String _obj4Ca) {
        this._obj4Ca = _obj4Ca;
    }

    public String get_obj4Peso() {
        return _obj4Peso;
    }

    public void set_obj4Peso(String _obj4Peso) {
        this._obj4Peso = _obj4Peso;
    }

    public String get_obj4Esp() {
        return _obj4Esp;
    }
